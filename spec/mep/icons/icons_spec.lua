...
describe('mep.icons.icons', function()
  ...
  describe('get_ui_icon', function()
    it('looks up a curated UI action icon (default nerd_font style)', function()
      ...
      assert.are.equal('🌲', icons.get_ui_icon('filetree'))
      assert.are.equal('📑', icons.get_ui_icon('symbols'))
    end)
    ...
    it('ascii style has plain 7-bit fallbacks', function()
      ...
      assert.are.equal('t', icons.get_ui_icon('filetree', { style = 'ascii' }))
      assert.are.equal('=', icons.get_ui_icon('symbols', { style = 'ascii' }))
    end)
