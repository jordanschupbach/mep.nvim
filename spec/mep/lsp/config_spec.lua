...
describe('mep.lsp.config', function()
  ...
  it('has sensible defaults', function()
    ...
    assert.are.same({ '[d' }, config.defaults.keymaps.diagnostic_prev)
    assert.are.same({ ']d' }, config.defaults.keymaps.diagnostic_next)
    assert.are.same({ '[e' }, config.defaults.keymaps.diagnostic_prev_error)
    assert.are.same({ ']e' }, config.defaults.keymaps.diagnostic_next_error)
  end)
