...
describe('mep.org.config', function()
  ...
  it('has sensible defaults', function()
    ...
    assert.is_true(config.defaults.todo_highlight)
    assert.are.same({ TODO = 'DiagnosticError', DONE = 'DiagnosticOk' }, config.defaults.todo_keyword_colors)
  ...
  it('has defaults for the polyglot diagnostic keymaps', function()
    assert.are.same({ '[d' }, config.defaults.polyglot.keymaps.diagnostic_prev)
    assert.are.same({ ']d' }, config.defaults.polyglot.keymaps.diagnostic_next)
    assert.are.same({ '[e' }, config.defaults.polyglot.keymaps.diagnostic_prev_error)
    assert.are.same({ ']e' }, config.defaults.polyglot.keymaps.diagnostic_next_error)
  end)
end)
